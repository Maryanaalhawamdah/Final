...
function Home() {
  ...
  useEffect(() => {
    axios.get('http://localhost/magic/connection/dashbord/get_product.php')
      .then(response => {
...
// ===========  Get Categorie start ======================= // 
  ...
  useEffect(() => {
    axios.get('http://localhost/magic/connection/dashbord/get_categories.php')
      .then(response => {
...
useEffect(() => {
  axios.get('http://localhost/magic/connection/dashbord/get_users.php')
    .then(response => {
...
useEffect(() => {
  axios.get('http://localhost/magic/connection/dashbord/get_artist.php')
    .then(response => {
